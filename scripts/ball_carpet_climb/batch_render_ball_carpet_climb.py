...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Batch render ball-onto-carpet videos with Blender.",
    )
    parser.add_argument("--out-root", type=Path,
                        default=WORKSPACE_DIR / "renders" / "batch_ball_carpet_climb")
    ...
    parser.add_argument("--preview-frame", type=int, default=17)
