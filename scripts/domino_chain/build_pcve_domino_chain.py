...
CASES = (
    RenderCase(
        case_id="domino_baseline",
        description="Baseline row of ten dominoes toppling in sequence.",
        seed=6001,
        overrides={},
    ),
    RenderCase(
        case_id="domino_long_chain",
        description="Longer row of sixteen dominoes for an extended cascade.",
        seed=6002,
        overrides={
            "physics": {
                "domino_count": 16,
    ...
    RenderCase(
        case_id="domino_wide_spacing",
        description="Wider spacing between tiles, closer to the topple-reach limit.",
        seed=6003,
        overrides={
            "physics": {
                "domino_spacing": 1.0,
    ...
    RenderCase(
        case_id="domino_light_push",
        description="Smaller critical tipping angle giving a slower, more gradual first fall.",
        seed=6004,
        overrides={
            "physics": {
                "push_angle_deg": 9.0,
    ...
    RenderCase(
        case_id="domino_bouncy",
        description="Higher restitution makes toppled tiles bounce more before settling.",
        seed=6005,
        overrides={
            "physics": {
                "domino_restitution": 0.35,
            },
        },
    ),
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a PCVE synthetic domino chain benchmark suite."
    )
    parser.add_argument(
        "--out-root",
        type=Path,
...
def main() -> None:
    ...
    manifest: dict[str, Any] = {
        ...
        "description": "Domino chain-reaction cases with PyBullet-driven trajectories for PCVE evaluation.",
