...
CASES = (
    RenderCase(
        ...
        description="Baseline pair of dice tumbling and landing in the table's dice tray.",
        seed=7001,
        overrides={},
    ),
    RenderCase(
        case_id="mahjong_dice_high_drop",
        description="Higher drop height gives the dice more time to tumble before landing.",
        seed=7002,
        overrides={
            "physics": {
                "drop_height": 0.8,
    ...
    RenderCase(
        case_id="mahjong_dice_bouncy",
        description="Higher restitution makes the dice bounce more before settling.",
        seed=7003,
        overrides={
            "physics": {
                "die_restitution": 0.85,
            },
        },
    ),
    RenderCase(
        case_id="mahjong_dice_heavy",
        description="Heavier dice settle faster with less bounce.",
        seed=7004,
        overrides={
            "physics": {
                "die_mass": 0.015,
                "die_restitution": 0.15,
            },
        },
    ),
    RenderCase(
        case_id="mahjong_dice_low_friction",
        description="Slicker tray surface lets the dice slide further after landing.",
        seed=7005,
        overrides={
            "physics": {
                "floor_friction": 0.2,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a PCVE synthetic mahjong dice benchmark suite."
    )
    parser.add_argument(
        "--out-root",
        type=Path,
...
def main() -> None:
    ...
    manifest: dict[str, Any] = {
        ...
        "description": "Mahjong dice-drop cases with PyBullet-driven trajectories for PCVE evaluation.",
