...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Batch render big/small marble collisions on the bar table.",
    )
    parser.add_argument("--out-root", type=Path,
                        default=WORKSPACE_DIR / "renders" / "batch_table_marble_collision")
    parser.add_argument("--count", type=int, default=4)
    parser.add_argument("--start-index", type=int, default=0)
    parser.add_argument("--seed-base", type=int, default=17000)
    parser.add_argument("--mode", choices=("preview", "animation", "frames"),
                        default="preview")
...
def sample_output_name(mode: str) -> str:
    ...
    return "table_marble_collision.mp4"
