...
CASES = (
    RenderCase(
        case_id="tennis_baseline",
        description="Baseline tennis flight with default physics and a gentle parabolic trajectory.",
        seed=3001,
        overrides={},
    ),
    RenderCase(
        case_id="tennis_high_bounce",
        description="Higher ball restitution leads to a more pronounced bounce after landing.",
        seed=3002,
        overrides={
            "physics": {
    ...
    RenderCase(
        case_id="tennis_heavy_ball",
        description="Heavier tennis ball carries more momentum and rolls farther after impact.",
        seed=3003,
        overrides={
            "physics": {
                "ball_mass": 0.15,
    ...
    RenderCase(
        case_id="tennis_cross_court",
        description="Cross-court launch angle adds a lateral velocity component to the trajectory.",
        seed=3004,
        overrides={
            "physics": {
                "launch_location": [-8.0, -4.0, 5.0],
                "launch_velocity": [5.0, 1.5, 0.0],
            },
        },
    ),
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a PCVE synthetic tennis flight benchmark suite."
    )
    parser.add_argument(
        "--out-root",
        type=Path,
...
def main() -> None:
    ...
    manifest: dict[str, Any] = {
        ...
        "description": "Tennis flight cases with PyBullet-driven trajectories for PCVE evaluation.",
