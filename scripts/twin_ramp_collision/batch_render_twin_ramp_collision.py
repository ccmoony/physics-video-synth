...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Batch render twin-ramp head-on collision videos with Blender.",
    )
    parser.add_argument("--out-root", type=Path,
                        default=WORKSPACE_DIR / "renders" / "batch_twin_ramp_collision")
...
def sample_output_name(mode: str) -> str:
    ...
    return "twin_ramp_collision.mp4"
